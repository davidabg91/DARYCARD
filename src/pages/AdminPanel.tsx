...
const ROUTES = [
    "Бъркач", "Тръстеник", "Биволаре", "Г.М", "Д. Дъбник",
    "Рибен", "Садовец", "Славовица", "Байкал", "Гиген",
    "Д.М", "Ясен", "Крушовица", "Дисевица", "Търнене", "Градина",
    "Петърница", "Опанец", "Победа", "Подем", "Божурица",
    "Телиш", "Ракита", "Радомирци", "Г. Дъбник",
    "Дисевица", "Търнене", "Петърница",
    "Д. Дъбник - Садовец", "Д.М - Тръстеник", "Д.М - Славовица"
];
