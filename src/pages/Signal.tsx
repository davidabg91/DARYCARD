...
const Signal: React.FC = () => {
    ...
    return (
        <div style={{ minHeight: '80vh', padding: '4rem 1rem 6rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ maxWidth: '800px', width: '100%', textAlign: 'center', marginBottom: '3rem' }}>
                <h1 style={{ fontSize: 'clamp(2.5rem, 8vw, 4rem)', fontWeight: 900, marginBottom: '1rem', letterSpacing: '-0.02em', color: '#fff' }}>
                    ПОДАЙ <span style={{ color: '#ff5252' }}>СИГНАЛ</span>
                </h1>
                <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto' }}>
                    Имате оплакване или искате да дадете съвет? Вашето мнение е важно за нас, за да подобрим нашите услуги.
                </p>
            </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', marginBottom: '0.5rem' }}>
                        <button
                            ...
                            style={{
                                flex: 1, padding: '1.25rem', borderRadius: '16px', fontWeight: 700, cursor: 'pointer', transition: 'all 0.3s ease',
                        ...
                        >
                            <MessageSquare size={20} /> СЪВЕТ / ПРЕПОРЪКА
                        </button>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            <label style={{ fontSize: '0.85rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', paddingLeft: '0.5rem' }}>ИМЕ (ПО ЖЕЛАНИЕ)</label>
                            <div style={{ position: 'relative' }}>
                                ...
                                <input
                                    ...
                                    style={{
                                        width: '100%', padding: '1rem 1rem 1rem 3rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)',
                                        borderRadius: '12px', color: '#fff', fontSize: '1rem', transition: 'all 0.2s ease'
                                    }}
                                />
                            </div>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            <label style={{ fontSize: '0.85rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', paddingLeft: '0.5rem' }}>ТЕЛЕФОН (ПО ЖЕЛАНИЕ)</label>
                            <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        <label style={{ fontSize: '0.85rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', paddingLeft: '0.5rem' }}>EMAIL (ПО ЖЕЛАНИЕ)</label>
                        <div style={{ position: 'relative' }}>
                    ...
                    {/* Message */}
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        <label style={{ fontSize: '0.85rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)', paddingLeft: '0.5rem' }}>ОПИСАНИЕ НА СИГНАЛА</label>
                        <textarea
                            required
                            value={message}
                            ...
                            style={{
                                width: '100%', minHeight: '150px', padding: '1.25rem', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)',
                                borderRadius: '16px', color: '#fff', fontSize: '1.1rem', transition: 'all 0.2s ease', resize: 'vertical', lineHeight: 1.5
                            }}
                        />
                    </div>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%', padding: '1.25rem', borderRadius: '16px', background: type === 'complaint' ? '#ff5252' : '#0091ea',
                            color: '#fff', fontWeight: 800, fontSize: '1.2rem', cursor: status === 'submitting' ? 'not-allowed' : 'pointer',
                            border: 'none', transition: 'all 0.3s ease', opacity: status === 'submitting' ? 0.7 : 1,
                            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem',
                            boxShadow: `0 10px 30px ${type === 'complaint' ? 'rgba(255,82,82,0.3)' : 'rgba(0,145,234,0.3)'}`,
                            marginTop: '1rem'
                        }}
                    >
                        {status === 'submitting' ? 'ИЗПРАЩАНЕ...' : (
                            <>
                                <Send size={20} /> ИЗПРАТИ СИГНАЛ
                            </>
                        )}
                    </button>

                    {status === 'error' && (
                        <p style={{ color: '#ff5252', textAlign: 'center', fontWeight: 600 }}>
