...
import { ROUTE_METADATA, abbreviate, disabledDiscountPct } from '../data/routeMetadata';
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{ margin: 0, lineHeight: 1.4, fontWeight: 500 }}>
                                                {meta?.priceCardStudent ? (
                                                    ...
                                                    <>Цените за ученици и пенсионери са <span style={{ color: 'var(--primary-color)', fontWeight: 700 }}>-50%</span> от тези цени, а за хора с увреждания над 70.99% са с <span style={{ color: 'var(--primary-color)', fontWeight: 700 }}>-{disabledDiscountPct(line)}%</span>.</>
                                                )}
                                            </p>
                                        </div>
                ...
                <section id="info-section" className="mobile-info-section" style={{ marginTop: 'clamp(3rem, 10vw, 6rem)', padding: '0 1rem', overflowX: 'hidden' }}>
                    <div className="info-container">
                        ...
                        <div style={{ flex: '1', width: '100%', position: 'relative' }}>
                             ...
                             {/* How-to video — wrapped in a matching glass panel with no padding to maximize video size. Added cache buster ?v=5 to force browser refresh. */}
                             <div className="working-hours-card glass" style={{ marginTop: '1.5rem', padding: 0, overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                                 <video
                                     ...
                                     playsInline
                                     preload="metadata"
                                     poster={`${import.meta.env.BASE_URL}how-to-poster.jpg?v=5`}
                                     style={{ width: '100%', display: 'block', background: '#0a0e13' }}
                                 >
                                     <source src={`${import.meta.env.BASE_URL}how-to-get-card.mp4?v=5`} type="video/mp4" />
