...
export const ROUTE_METADATA: Record<string, RouteMetadata> = {
  ...
  "Биволаре": {
    ...
    priceSingle: "1.30 €",
    priceCard: "26.00 €",
    description: "Линия Плевен - Биволаре (обслужва се от курсовете за Тръстеник)."
  },
  "Победа": {
    stops: ["Плевен", "Опанец", "Д.М", "Победа"],
    priceSingle: "1.50 €",
    priceCard: "30.00 €",
    description: "Линия Плевен - Победа (обслужва се от курсовете за Рибен)."
  },
  "Крушовица": {
    stops: ["Плевен", "Ясен", "Крушовица"],
    priceSingle: "1.80 €",
    priceCard: "36.00 €",
    description: "Линия Плевен - Крушовица (обслужва се от курсовете за Садовец)."
  },
  "Божурица": {
    stops: ["Плевен", "Опанец", "Д.М", "Победа", "Рибен", "Божурица"],
    priceSingle: "2.50 €",
    priceCard: "50.00 €",
    description: "Линия Плевен - Божурица (обслужва се от курсовете за Рибен)."
  },
  "Градина": {
    stops: ["Плевен", "Ясен", "Търнене", "Дисевица", "Градина"],
    priceSingle: "2.00 €",
    priceCard: "40.00 €",
    description: "Линия Плевен - Градина (обслужва се от курсовете за Бъркач)."
  }
};
