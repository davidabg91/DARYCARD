...
export const ROUTE_METADATA: Record<string, RouteMetadata> = {
  ...
  // Нови направления, добавени на 2026-09-25, за да може да се издават карти за
  // тях. Разписанието още не е известно — затова няма запис в SCHEDULES и
  // `listedRoutes()` ги държи извън „Актуални линии", извън страниците на
  // линиите и извън sitemap-а, докато часовете не дойдат. Спирките и цената на
  // билета също чакат разписанието: по-добре празно, отколкото измислен
  // маршрут. Цената на картата е дадена и работи веднага.
  "Ставерци": {
    stops: [],
    priceSingle: "---",
    priceCard: "75.00 €"
